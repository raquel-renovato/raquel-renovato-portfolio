  ...
  return (
    <section className="bg-brand-dark">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-16 sm:py-20 text-center">
        <h2 className="text-brand-white text-3xl sm:text-4xl font-extrabold tracking-tight max-w-xl mx-auto mb-4">
          Vamos trabalhar juntos?
        </h2>
        <p className="text-brand-white/70 max-w-md mx-auto mb-8">
