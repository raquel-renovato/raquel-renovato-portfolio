const checklist = [
  ...
  'Workflow Otimizado com IA Generativa',
];
    ...
    <section id="sobre" className="bg-brand-white">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-16 sm:py-20 lg:py-24">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-brand-dark/60 leading-relaxed mb-8 text-justify">
          ...
          <ul className="grid grid-flow-col grid-rows-2 gap-x-10 gap-y-3 w-fit">
            {checklist.map((item) => (
